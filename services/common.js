...
exports.cookieExtractor=function(req){
    ...
    //ToDo:this is temp token
    // token="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY2Y2M3OTk0NDQ5Mjk4NTNiODNjMTkwMyIsInJvbGUiOiJ1c2VyIiwiaWF0IjoxNzI0NzM2NjU0fQ.Vkn7HV0OmP8lSY2BPiFJ5VgX3vB3bSwIGhmSxMp4OLY"
    return token;
  }
           ...
           <tr>
             <td align="center" valign="top" style="padding: 36px 24px;">
               <a href="https://sendgrid.com" target="_blank" style="display: inline-block;">
                 <img src="./img/paste-logo-light@2x.png" alt="ShopNest" border="0" width="48" style="display: block; width: 48px; max-width: 48px; min-width: 48px;">
               </a>
             </td>
           </tr>
         </table>
         ...
         <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
           ...
           <tr>
             <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
               <p style="margin: 0;">Here is a summary of your recent order. If you have any questions or concerns about your order, please <a href="sachinthakur2326@gmail.com">contact us</a>.</p>
             </td>
           </tr>
           <!-- end copy -->
                 ...
                 <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 300px;">
                   <tr>
                     <td align="left" valign="top" style="padding-bottom: 36px; padding-left: 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                       ...
                       <p>${order.selectAddress.name}<br>${order.selectAddress.street}<br>${order.selectAddress.city},${order.selectAddress.state},${order.selectAddress.pincode}</p>
